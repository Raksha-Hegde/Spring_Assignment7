...
public class UserController {
	 ...
	 * differen@RestControllert situations: 1. 200(OK) - If login is successful 2.
	 * 404(NOT FOUND) - If the user with the searched for is not found This handler
	 * method should map to the URL "/api/user/{username}" using HTTP GET method
